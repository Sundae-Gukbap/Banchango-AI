...
public class IngredientService {
    ...
    public void insertIngredient(Long userId, IngredientInsertRequest request) {
        ...
        ConatinerIngredient conatinerIngredient = request.toEntity(container, ingredient);
        containerIngredientRepository.save(conatinerIngredient);
    }
    ...
    public void removeIngredient(Long containerId, Long ingredientId) {
        ...
        ConatinerIngredient conatinerIngredient = containerIngredientRepository.findByContainerAndIngredient(container, ingredient)
                .orElseThrow(() -> new NoSuchElementException("user doesn't have ingredient"));
        containerIngredientRepository.delete(conatinerIngredient);
    }
}
